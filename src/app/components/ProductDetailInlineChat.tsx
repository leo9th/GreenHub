              ...
              <div className="mt-3 flex flex-wrap gap-2">
                ...
                {whatsappHref ? (
                  <a
                    ...
                    className="inline-flex flex-1 min-w-[7rem] items-center justify-center gap-2 rounded-lg bg-[#25D366] px-3 py-2 text-center text-xs font-semibold text-white hover:opacity-95"
