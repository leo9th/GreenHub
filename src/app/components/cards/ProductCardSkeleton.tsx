  ...
  return (
    ...
    >
      {Array.from({ length: count }, (_, i) => (
        <div
          key={i}
          className="block h-full w-full overflow-hidden rounded-xl border border-gray-200 dark:border-border bg-white dark:bg-card shadow-sm"
        >
          <div className="relative w-full bg-gray-100 dark:bg-muted" style={{ paddingBottom: "100%" }}>
          ...
          <div className="flex flex-col gap-2 border-t border-gray-100 dark:border-border bg-white dark:bg-card p-4">
