// Global Mock Data Store (Replacing nigeriaData.ts)
...
export const globalLocations = {
  ...
  US: ["New York, NY", "Los Angeles, CA", "Chicago, IL", "Houston, TX", "Miami, FL"],
  CN: ["Beijing", "Shanghai", "Shenzhen", "Guangzhou", "Chengdu"]
};

// Generates mock products based on region and currency
export const getMockProductsForRegion = (region: "NG" | "US" | "CN") => {
  const multipliers = { NG: 1, US: 0.00065, CN: 0.0047 }; // Rough conversion from Base NGN prices for mock visually
  const mult = multipliers[region];
  const locations = globalLocations[region];
  ...
  return [
    ...
    },
    {
      ...
      title: "Wireless Echo Speaker",
      price: Math.floor(40000 * mult),
