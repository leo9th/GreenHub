-- Use this ONLY if public.conversations has buyer_id + seller_id (not participant_a/b).
-- Run in Supabase SQL Editor after your table exists.
...
-- chat_messages: subquery must use buyer_id/seller_id
